...
// the bottom-right corner. Blanks the backlight after
// DISPLAY_BLANK_TIMEOUT_MS idle and wakes on touch WITHOUT the waking
// touch pressing any UI element (#248). History graphs are card #223.
